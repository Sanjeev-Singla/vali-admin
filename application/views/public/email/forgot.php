    ...
    <td  valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
		  <td><img width="100px" src="http://voicemyfeedback.com/assets/img/11.png"></td>
		  </tr>
		  <tr>
		  ...
		  <tr>
            <td class="header-lg">
              Welcome to Voice Mycomplaint
            </td>
			</tr>
			<tr>
			<td class="free-text">
                  <p>We're apologize for the inconvience this may have caused you. Please Visit the below Link to reset your Password.</p>
                  <b>Thank you.</b>
                  <p>Regards</p>
                  <p>Voice My Complaints.</p>
			</td>
          </tr>
          
          <tr>
            <td class="button">
              <div><a class="button-mobile" href="<?= $activate_link ?>"
